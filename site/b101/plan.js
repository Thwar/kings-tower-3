...
export const walls = [
  [5.7, 0, 0, 0, 'wall'], [5.7, 0, 5.7, 6.8, 'wall'],
  [0, 0, 0, 17.5, 'wall'],
  [5.7, 6.8, 5.1, 6.8, 'wall'], [2.7, 6.8, 0, 6.8, 'wall'], [5.1, 6.8, 2.7, 6.8, 'head'],
  [1.3, 5.5, 1.1, 5.5, 'wall'], [0.3, 5.5, 0, 5.5, 'wall'], [1.1, 5.5, 0.3, 5.5, 'head'], [1.3, 5.5, 1.3, 6.8, 'wall'],
  [5.7, 6.8, 5.7, 17.5, 'wall'], [5.7, 9.65, 4.5, 9.65, 'wall'],
  [5.7, 17.5, 5.2, 17.5, 'wall'], [4.3, 17.5, 0, 17.5, 'wall'], [5.2, 17.5, 4.3, 17.5, 'head'],
  [2.1, 6.8, 2.1, 7, 'wall'], [2.1, 7.7, 2.1, 10, 'wall'], [2.1, 10.8, 2.1, 12.9, 'wall'],
  [2.1, 7, 2.1, 7.7, 'head'], [2.1, 10, 2.1, 10.8, 'head'],
